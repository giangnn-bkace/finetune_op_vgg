...
data_dir = "train_classifier_layer_data"
save_model_name = "step1.h5"
...
if __name__ == "__main__":
	...
	test_data = nngutil.prepare_data(data_dir, IMG_WIDTH, IMG_HEIGHT, BATCH_SIZE, CLASS_MODE, shuffle=False)
	# load open pose trained weights
	open_pose_model = get_testing_model()
	open_pose_model.load_weights(keras_weights_file)
